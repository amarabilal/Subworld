...
Subworld is a social media platform inspired by Reddit, built using the Symfony framework. The project allows users to create and manage communities (Subworlds), share posts, comment, and interact with other users through voting, private messaging, and more.
